...
import com.codegym.Service.SQLConnection;
...
public class CustomerRepository {
    ...
    final static String SAVE_CUSTOMER = "UPDATE Customer SET customerId=?, customerName=?, " +
    ...
    public ArrayList<Customer> customerSearchWithText(String query){
        Connection conn = connection.getConnection();
        ArrayList<Customer> searchCustomerList= new ArrayList<>();

        String SEARCH = "SELECT * FROM Customer WHERE customerName like '%"+ query +"%' ";
