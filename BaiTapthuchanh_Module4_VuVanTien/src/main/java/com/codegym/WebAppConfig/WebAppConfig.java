...
public class WebAppConfig extends WebMvcConfigurerAdapter implements ApplicationContextAware {
    ...
    public DataSource dataSource() {
        ...
        dataSource.setUrl("jdbc:mysql://localhost:3306/BaitapthuchanhModule4");
    ...
    @Bean
    public ICategoryService getCategoryService(){return new CategoryService(); }
    @Bean
    public IProductService getProductService(){return new ProductService();}
